...
import headshot from '../public/images/Headshot1.jpeg'

const user = {
  name: 'Jared Lemke',
  email: 'jared@elitefantasy.com',
  imageUrl: headshot
}
const navigation = [
  { name: 'Dashboard', href: '/', current: true },
  { name: 'User Management', href: '/user_management', current: false },
]
				...
				<div className="py-10">
					<header>
						{/* <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
							<h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Elite Fantasy</h1>
						</div> */}
					</header>
					<main>
						<div className="mx-auto max-w-screen text-lg text-gray-900 sm:px-6 lg:px-8">
							{props.children}
						</div>
					</main>
				</div>
